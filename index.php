<?php
	...
	unset($_SESSION['PBB_SCHOOL']);
	unset($_SESSION['PBB_LEVEL']);
...
<html>
    ...
    <head>
        ...
        <title>DEPED - BOHOL - PBB 2020</title>
...
?>
		...
		<div id="formContainer">
		  ...
		  <form id="login" method="post" action="login.php">
				...
				<?php /* <a href="#" id="flipToRecover" class="flipLink">Forgot?</a> */ ?>
				...
				<select name="level" id="loginLevel">
